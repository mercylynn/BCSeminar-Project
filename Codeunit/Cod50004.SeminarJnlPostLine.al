codeunit 50004 SeminarJnlPostLine
{
    ...
    PROCEDURE RunWithCheck(VAR SeminarJnlLine2: Record SeminarJournalLine)
    BEGIN
    ...
    BEGIN
        ...
        SeminarLedgerEntry."Room Code." := SeminarJnlLine."Room Code.";
